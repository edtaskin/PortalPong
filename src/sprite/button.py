...
class Button:
    def __init__(self, content, rect, action, outline_color="white", background_color="black", text=None):
        self.text = text
    ...
    @classmethod
    def from_image(cls, img, rect, action, outline_color="white"):
        return cls(img, rect, action, outline_color)

    @classmethod
    def from_text(cls, text, font, rect, action, text_color="white", outline_color="white", background_color="black"):
        return cls(font.render(text, False, text_color), rect, action, outline_color=outline_color, background_color=background_color, text=text)
